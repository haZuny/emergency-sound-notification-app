...
carHorn_path = 'D:/hajun/논문/emergency-sound-notification-app/Deep Learning/dataset/training-data/car_horn/'
other_path = 'D:/hajun/논문/emergency-sound-notification-app/Deep Learning/dataset/training-data/other/'
shuffle_path = 'D:/hajun/논문/emergency-sound-notification-app/Deep Learning/dataset/training-data/shuffle/'
...
model.add(layers.Conv2D(32, (3,3), activation='relu', input_shape=(64, 256, 1)))
...
trained = model.fit(X_train, Y_train, epochs=50, validation_data=(X_val, Y_val))
